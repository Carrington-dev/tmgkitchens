  ...
  <main class="main">
    ...
    <section id="skills" class="skills section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Skills</h2>
        <p>We offer tailored services to meet your specific needs and preferences.</p>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row skills-content skills-animation">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill"><span>Shelves Carpentry</span> <i class="val">100%</i></span>
            ...
            <div class="progress">
              <span class="skill"><span>Kitchen Carpentry</span> <i class="val">95%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill"><span>Kitchen Renovation</span> <i class="val">75%</i></span>
              <div class="progress-bar-wrap">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill"><span>Bedroom Wardrobes</span> <i class="val">80%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill"><span>Coffee Tables</span> <i class="val">90%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill"><span>Kitchen tables </span> <i class="val">55%</i></span>
              <div class="progress-bar-wrap">
